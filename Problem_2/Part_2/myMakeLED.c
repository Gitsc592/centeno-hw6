...
/////////////////////////////////////////////////////////////////////////
// Filename : myMakeLED.c
// Editor : Sed Centeno
// Date : 10/18/2024
//
// Description:
// This code has been edited to flash the LED at a rate of 0.5 Hz if the user
// enters an incorrect command.
//
// NOTE:
// Since the code is using the timer function of the LED, it must be run as sudo
//
// New Example Invocation:
// sudo ./myMakeLED bad_command
/////////////////////////////////////////////////////////////////////////
